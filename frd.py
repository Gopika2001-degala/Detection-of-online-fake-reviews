...
#from sklearn.semi_pip import sklearnsupervised 
...
main = tkinter.Tk()
main.title("Fake Review Detection using Supervised Learning and Semi-Supervised Learning")
...
font = ('times', 16, 'bold')
title = Label(main, text='Fake Review Detection using Supervised Learning and Semi-Supervised Learning')
